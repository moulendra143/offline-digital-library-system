...
$selectquery = "SELECT id, code, filename FROM ebook"; // Include 'code' column in the query
    ...
    <section>
        <header>
          ...
          <div class="search-bar" style="padding-left:1200px">
            <form method="" action="sviewpdfe-book.php"> <!-- Create a PHP file 'search.php' to handle the search -->
